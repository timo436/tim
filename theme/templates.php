...
<head>
<meta charset="utf-8">
<title>Xelina's Closet / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Cellphone No. (+63) 09162143285</p>
                ...
                if (isset($_SESSION['gcCart'])) {
                 ...
                 if (isset($_SESSION['CustomerID'])) { 
                    ...
                    echo '<a title="View Message(s)" href="'.web_root.'customer/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">'.$msg.'</span></a> | <a title="View Profile" href="'.web_root.'customer/"> <i class="fa fa-user"></i> '. $cus->CustomerName .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> ';
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Xelina's Closet<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Malinta Valenzuela City</address>
          <p>
            <i class="icon-phone"></i> (+63) 09162143285 <br>
            <i class="icon-envelope-alt"></i> xelinascloset25@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Xelina's Closet 2020 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://www.facebook.com/Xelinascloset25" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="https://www.facebook.com/tim.palisoc" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://www.facebook.com/tim.palisoc" data-placement="top" title="Linkedin"><i class="fa fa-linkedin"></i></a></li>
            <li><a href="https://www.facebook.com/tim.palisoc" data-placement="top" title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
            <li><a href="https://www.facebook.com/tim.palisoc" data-placement="top" title="Google plus"><i class="fa fa-google-plus"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
