...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>" class="logo">
      ...
      <span class="logo-lg"><b>Xelina</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <aside class="main-sidebar">
   ...
   <!--      <li class="<?php echo (currentpage() == 'store') ? "active" : false;?>" >
        ...
        <li class="<?php echo (currentpage() == 'report_XD') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/report_XD/">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://www.facebook.com/Xelinascloset25">Xelina's Closet</a></strong> All rights
    reserved.
  </footer>
